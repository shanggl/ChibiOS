 ...
 */
static void usart_init_ll(SerialDriver *sdp, const SerialConfig *config) {
  uint32_t brr;
  usart_type *u = sdp->usart;
  ...
  u->ctrl2 = config->cr2 | USART_CR2_LBDIE;
  u->ctrl3 = config->cr3 | USART_CR3_EIE;
  u->ctrl1 = config->cr1 | USART_CR1_UE | USART_CR1_PEIE |
 ...
 */
static void usart_deinit(usart_type *u) {
...
static void notify1(io_queue_t *qp) {
  ...
  (void)qp;
  USART1->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify2(io_queue_t *qp) {
  ...
  (void)qp;
  USART2->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify3(io_queue_t *qp) {
  ...
  (void)qp;
  USART3->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify4(io_queue_t *qp) {
  ...
  (void)qp;
  UART4->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify5(io_queue_t *qp) {
  ...
  (void)qp;
  UART5->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify6(io_queue_t *qp) {
  ...
  (void)qp;
  USART6->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify7(io_queue_t *qp) {
  ...
  (void)qp;
  UART7->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify8(io_queue_t *qp) {
  ...
  (void)qp;
  UART8->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify9(io_queue_t *qp) {
  ...
  (void)qp;
  UART9->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
...
static void notify10(io_queue_t *qp) {
  ...
  (void)qp;
  UART10->ctrl1 |= USART_CR1_TXEIE | USART_CR1_TCIE;
}
#endif
