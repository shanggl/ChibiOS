...
const stm32_dma_stream_t _stm32_dma_streams[STM32_DMA_STREAMS] = {
  {EDMA_STREAM1, &EDMA->clr1, DMA1_CH0_VARIANT,  0,  0, STM32_DMA1_CH0_NUMBER},
  {EDMA_STREAM2, &EDMA->clr1, DMA1_CH1_VARIANT,  6,  1, STM32_DMA1_CH1_NUMBER},
  {EDMA_STREAM3, &EDMA->clr1, DMA1_CH2_VARIANT, 16,  2, STM32_DMA1_CH2_NUMBER},
  {EDMA_STREAM4, &EDMA->clr1, DMA1_CH3_VARIANT, 22,  3, STM32_DMA1_CH3_NUMBER},
  {EDMA_STREAM5, &EDMA->clr2, DMA1_CH4_VARIANT,  0,  4, STM32_DMA1_CH4_NUMBER},
  {EDMA_STREAM6, &EDMA->clr2, DMA1_CH5_VARIANT,  6,  5, STM32_DMA1_CH5_NUMBER},
  {EDMA_STREAM7, &EDMA->clr2, DMA1_CH6_VARIANT, 16,  6, STM32_DMA1_CH6_NUMBER},
  {EDMA_STREAM8, &EDMA->clr2, DMA1_CH7_VARIANT, 22,  7, STM32_DMA1_CH7_NUMBER},
/*
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH0_HANDLER) {
  ...
  flags = (EDMA->sts1 >> 0U) & STM32_DMA_ISR_MASK;
  EDMA->clr1 = flags << 0U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH1_HANDLER) {
  ...
  flags = (EDMA->sts1 >> 6U) & STM32_DMA_ISR_MASK;
  EDMA->clr1 = flags << 6U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH2_HANDLER) {
  ...
  flags = (EDMA->sts1 >> 16U) & STM32_DMA_ISR_MASK;
  EDMA->clr1= flags << 16U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH3_HANDLER) {
  ...
  flags = (EDMA->sts1 >> 22U) & STM32_DMA_ISR_MASK;
  EDMA->clr1 = flags << 22U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH4_HANDLER) {
  ...
  flags = (EDMA->sts2 >> 0U) & STM32_DMA_ISR_MASK;
  EDMA->clr2 = flags << 0U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH5_HANDLER) {
  ...
  flags = (EDMA->sts2 >> 6U) & STM32_DMA_ISR_MASK;
  EDMA->clr2 = flags << 6U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH6_HANDLER) {
  ...
  OSAL_IRQ_PROLOGUE();
  flags = (EDMA->sts2 >> 16U) & STM32_DMA_ISR_MASK;
  EDMA->clr2 = flags << 16U;
...
OSAL_IRQ_HANDLER(STM32_DMA1_CH7_HANDLER) {
  ...
  OSAL_IRQ_PROLOGUE();
  flags = (EDMA->sts2 >> 22U) & STM32_DMA_ISR_MASK;
  EDMA->clr2 = flags << 22U;
...
void dmaInit(void) {
  ...
  for (i = 0U; i < STM32_DMA_STREAMS; i++) {
    _stm32_dma_streams[i].stream->ctrl = STM32_DMA_CR_RESET_VALUE;
    dma.streams[i].func = NULL;
  }
  EDMA->clr1 = 0xFFFFFFFFU;
  EDMA->clr2 = 0xFFFFFFFFU;
/*
...
const stm32_dma_stream_t *dmaStreamAllocI(uint32_t id,
  ...
  for (i = startid; i <= endid; i++) {
    ...
    if ((dma.allocated_mask & mask) == 0U) {
      ...
      dmastp->stream->ctrl = STM32_DMA_CR_RESET_VALUE;
      dmastp->stream->fctrl = STM32_DMA_FCR_RESET_VALUE;
