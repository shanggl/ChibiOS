...
static void i2c_lld_setup_rx_transfer(I2CDriver *i2cp) {
  ...
  /* Configures the CR2 registers with both the calculated and static
     settings.*/
  dp->ctrl2 = (dp->ctrl2 & ~(I2C_CR2_NBYTES | I2C_CR2_RELOAD)) | i2cp->config->cr2 |
...
static void i2c_lld_abort_operation(I2CDriver *i2cp) {
  ...
  if (dp->ctrl1 & I2C_CR1_PE) {
    /* Stops the I2C peripheral.*/
    dp->ctrl1 &= ~I2C_CR1_PE;
    while (dp->ctrl1 & I2C_CR1_PE)
      dp->ctrl1 &= ~I2C_CR1_PE;
    dp->ctrl1 |= I2C_CR1_PE;
  }
...
#else
  dp->ctrl1 &= ~(I2C_CR1_TXIE | I2C_CR1_RXIE);
#endif
}
...
static void i2c_lld_serve_interrupt(I2CDriver *i2cp, uint32_t isr) {
  ...
  if ((isr & I2C_ISR_NACKF) != 0U) {
    ...
    dp->ctrl2 |= I2C_CR2_STOP;

    /* Make sure no more interrupts.*/
    dp->ctrl1 &= ~(I2C_CR1_TCIE | I2C_CR1_TXIE | I2C_CR1_RXIE);
...
static void i2c_lld_serve_error_interrupt(I2CDriver *i2cp, uint32_t isr) {
  ...
  i2cp->i2c->ctrl1 &= ~(I2C_CR1_TXIE | I2C_CR1_RXIE);
#endif
...
OSAL_IRQ_HANDLER(STM32_I2C1_EVENT_HANDLER) {
  uint32_t isr = I2CD1.i2c->sts;

  OSAL_IRQ_PROLOGUE();

  /* Clearing IRQ bits.*/
  I2CD1.i2c->clr = isr & I2C_INT_MASK;
...
OSAL_IRQ_HANDLER(STM32_I2C1_ERROR_HANDLER) {
  ...
  /* Clearing IRQ bits.*/
  I2CD1.i2c->clr = isr & I2C_ERROR_MASK;
...
OSAL_IRQ_HANDLER(STM32_I2C2_EVENT_HANDLER) {
  uint32_t isr = I2CD2.i2c->sts;

  OSAL_IRQ_PROLOGUE();

  /* Clearing IRQ bits.*/
  I2CD2.i2c->clr = isr & I2C_INT_MASK;
...
OSAL_IRQ_HANDLER(STM32_I2C2_ERROR_HANDLER) {
  ...
  /* Clearing IRQ bits.*/
  I2CD2.i2c->clr = isr & I2C_ERROR_MASK;
...
OSAL_IRQ_HANDLER(STM32_I2C3_EVENT_HANDLER) {
  uint32_t isr = I2CD3.i2c->sts;

  OSAL_IRQ_PROLOGUE();

  /* Clearing IRQ bits.*/
  I2CD3.i2c->clr = isr & I2C_INT_MASK;
...
OSAL_IRQ_HANDLER(STM32_I2C3_ERROR_HANDLER) {
  ...
  /* Clearing IRQ bits.*/
  I2CD3.i2c->clr = isr & I2C_ERROR_MASK;
...
#error "I2C4 interrupt numbers not defined"
  ...
  dp->clkctrl = i2cp->config->timingr;
...
msg_t i2c_lld_master_receive_timeout(I2CDriver *i2cp, i2caddr_t addr,
  ...
  dp->ctrl1 |= I2C_CR1_TCIE | I2C_CR1_RXIE;
#endif
...
msg_t i2c_lld_master_transmit_timeout(I2CDriver *i2cp, i2caddr_t addr,
  ...
  dp->ctrl1 |= I2C_CR1_TCIE | I2C_CR1_TXIE;
#endif
