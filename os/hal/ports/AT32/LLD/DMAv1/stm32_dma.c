...
#define DMAMUX2_CHANNEL(id)         (DMA2MUX_BASE + ((id) * 4U))

#define DMA1_CH1_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(0))
#define DMA1_CH2_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(1))
#define DMA1_CH3_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(2))
#define DMA1_CH4_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(3))
#define DMA1_CH5_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(4))
#define DMA1_CH6_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(5))
#define DMA1_CH7_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(6))
//#define DMA1_CH8_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(7))
#define DMA2_CH1_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(0))
#define DMA2_CH2_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(1))
#define DMA2_CH3_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(2))
#define DMA2_CH4_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(3))
#define DMA2_CH5_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(4))
#define DMA2_CH6_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(5))
#define DMA2_CH7_VARIANT            ((dmamux_channel_type *)DMAMUX2_CHANNEL(6))
//#define DMA2_CH8_VARIANT            ((dmamux_channel_type *)DMAMUX1_CHANNEL(7 + STM32_DMA1_NUM_CHANNELS))
...
void dmaInit(void) {
  ...
  for (i = 0; i < STM32_DMA_STREAMS; i++) {
    _stm32_dma_streams[i].channel->ctrl = STM32_DMA_CCR_RESET_VALUE;
...
const stm32_dma_stream_t *dmaStreamAllocI(uint32_t id,
  ...
  for (i = startid; i <= endid; i++) {
    ...
    if ((dma.allocated_mask & mask) == 0U) {
      ...
      dmastp->channel->ctrl = STM32_DMA_CCR_RESET_VALUE;
...
void dmaServeInterrupt(const stm32_dma_stream_t *dmastp) {
  ...
  flags = (dmastp->dma->sts >> dmastp->shift) & STM32_DMA_ISR_MASK;
